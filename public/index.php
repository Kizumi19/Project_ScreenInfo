        ...
        <div class="row align-items-start">
            ...
            <div class="col-md-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row gx-5">
                        <div class="col-md-4">
                            <img src="src/EditIcon.png" style="max-width: 100%; max-height: 200px;" class="img-fluid img-limited rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-md-6 ">
                <div class="card mb-3">
                    <div class="row gx-5 " >
                        <div class="col-md-4" >
                            <img src="src/MostrarInfoIcona.png" style="max-width: 100%; max-height: 200px;" class="img-fluid imatge-visualitzar rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
